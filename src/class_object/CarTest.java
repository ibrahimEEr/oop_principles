...
public class CarTest {
    public static void main(String[] args) {
         ...
         */
        System.out.println("---Blue or Beige");
//        int blueOrBeige2023 = 0;
//        for (Car car : cars) {
//            if(car.color.equals("Blue") || car.color.equals("Beige") || car.year == 2023) blueOrBeige2023++;
//        }
//        System.out.println(blueOrBeige2023);
        System.out.println(cars.stream().filter(x -> x.color.equals("Blue") || x.color.equals("Beige") || x.year == 2023).count());
        ...
        3
         */
        System.out.println("----Remove Teslas-------");

        cars.removeIf(x-> x.make.equals("Tesla"));
